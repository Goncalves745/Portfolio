...
import { Code, Layers, Layout, Database, LineChart, ShieldCheck } from 'lucide-react';
...
const Skills = () => {
  ...
  const categoryIcons = {
    'Programming Languages': <Code className="text-primary-600 dark:text-primary-400" />,
    'Web Development': <Layout className="text-secondary-600 dark:text-secondary-400" />,
    'Frameworks & Libraries': <Layers className="text-accent-600 dark:text-accent-400" />,
    'Databases': <Database className="text-success-600 dark:text-success-400" />,
    'Data Science & AI': <LineChart className="text-warning-600 dark:text-warning-400" />,
    'Tools & Others': <ShieldCheck className="text-error-600 dark:text-error-400" />,
  };
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              I'm constantly learning and expanding my skillset, but here are the technologies 
              and tools I'm currently proficient with.
            </p>
          </motion.div>
